...
<body>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                ...
                <div class="col-sm-12">
                    ...
                    <h3>Total de Proyectos Pausados: <strong>{{$cantidad}}</strong></h3>
                        ...
                        <div class="panel panel-primary text-center  bg-color-black">
                            <div class="panel-body">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <button id="cambiar_estado" class="btn btn-lg btn-warning">Cambiar de Estado</button>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        //////////////Codigo agregado solo en proyectosStandBy lo demas es igual, JS.
        $("body").on("click","#cambiar_estado",function(){
            ...
            if( estado != 2 )
            {
                ...
                swal("Error","El Estado sigue siendo el mismo","error")
            }
